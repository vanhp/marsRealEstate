...
import com.vanh.android.marsrealestate.databinding.FragmentOverviewBinding
import com.vanh.android.marsrealestate.databinding.GridViewItemBinding
...
class OverviewFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        viewModel.navigate2SelectedProperty.observe(viewLifecycleOwner, Observer {
            if(null != it){
